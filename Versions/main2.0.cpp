...
//cout << mat_sub("[11+3i 2 3 4 5 6;11 2 3 4 5 6]" , "[11 2 3 4 5 6;11 2 3 4 5 6]");

//cout << find_dubchar("[1 2 3;4 5 6;1 2 3 4;]" , ';' , 2);

int start , ending;
row_indexes("[1;1;2;3]" , 4, start , ending);
//cout << start << "  " << ending;

//cout << find_dubchar("[1;1;2;3]" , ';' , 3);

//cout << num_of_columns("[11 2 3 4 5 6]");

//cout << mat_row("[11 2 3 4 5 6]" , 1);

//cout << element_extract("[11 2 3 4 5 6]" , 1 ,6);
